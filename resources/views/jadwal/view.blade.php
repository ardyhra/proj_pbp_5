...
<div class="container mx-auto mt-10">
    ...
    <!-- <a href="{{ route('jadwal.create', ['id_tahun' -> $id_tahun, 'id_prodi' -> $id_prodi]) }}" class="inline-block bg-green-500 text-white px-6 py-2 rounded-md hover:bg-green-600 mb-4">Tambah Jadwal Baru</a>
    -->
...
<div class="container mx-auto mt-10">
    ...
    <div class="flex justify-between mb-4">
        ...
        <!-- Tombol Ajukan Jadwal ke Dekan -->
        {{-- <a href="{{ route('jadwal.ajukan', ['id_tahun' => $id_tahun, 'id_prodi' => $id_prodi]) }}" class="inline-block bg-blue-500 text-white px-6 py-2 rounded-md hover:bg-blue-600">Ajukan Jadwal ke Dekan</a>
     --}}
    </div>
