...
<body class="bg-gray-100 font-sans">
    ...
    <div class="flex">
        ...
        <main class="w-full lg:w-4/5 lg:ml-auto p-8">
            ...
            <div id="tombol-aksi-container" class="mt-6 flex space-x-4 justify-end">
                <button onclick="setujuiUsulan()" class="bg-green-500 text-white px-6 py-2 rounded-lg font-semibold hover:bg-green-600">Setujui Usulan</button>
                <button onclick="tolakUsulan()" class="bg-red-500 text-white px-6 py-2 rounded-lg font-semibold hover:bg-red-600">Tolak Usulan</button>
                <button onclick="berikanIzin()" class="bg-yellow-500 text-white px-6 py-2 rounded-lg font-semibold hover:bg-yellow-600">Berikan Izin Perbaikan</button>
            </div>
        </main>
    </div>
    ...
    <script>
        ...
        function berikanIzin() {
            alert("Izin untuk perbaikan usulan telah diberikan.");
        }
    </script>
